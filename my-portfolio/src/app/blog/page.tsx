...
import { Rss, ShieldCheck, GitBranch, BookOpen, TrendingUp } from "lucide-react";
import BlogCard from "@/components/BlogCard";

export const metadata = {
  title: "Blog | Academic Insights",
  description: "Explore insights on computer networks, security, blockchain, and emerging technologies."
};
...
export default async function BlogPage() {
  ...
  const categoryIcons: { [key: string]: React.ReactNode } = {
    "Network Security": <ShieldCheck className="w-5 h-5" />,
        ...
        <div className="container mx-auto px-4 py-20 sm:py-28">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl sm:text-2xl text-gray-600 dark:text-gray-300 mb-8 leading-relaxed max-w-3xl mx-auto">
              Deep dives into <span className="font-semibold text-blue-600 dark:text-blue-400">network security</span>, 
              <span className="font-semibold text-purple-600 dark:text-purple-400"> blockchain</span>, and 
              <span className="font-semibold text-green-600 dark:text-green-400"> emerging technologies</span>
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-md mx-auto mb-12">
              <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-4 border border-gray-200 dark:border-gray-700">
                ...
                <div className="text-gray-600 dark:text-gray-300 text-sm">Articles</div>
              </div>
              <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-4 border border-gray-200 dark:border-gray-700">
                <div className="text-2xl font-bold text-purple-600 dark:text-purple-400 mb-1">
                  {new Set(allPosts.flatMap(p => p.tags)).size}
                </div>
                <div className="text-gray-600 dark:text-gray-300 text-sm">Topics</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <section className="mb-16">
            <div className="flex items-center gap-3 mb-8">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300">Latest insights and discoveries</p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {recentPosts.map((post) => (
                <BlogCard
                  ...
                  categoryColor={categoryColors[post.tags?.[0]] || "bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-300"}
                  image={post.image}
                  icon={categoryIcons[post.tags?.[0]] || <Rss className="w-5 h-5" />}
                  isRecent={true}
                />
              ))}
            </div>
          ...
          <section>
            <div className="flex items-center gap-3 mb-8">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300">Complete collection of technical writings</p>
              </div>
